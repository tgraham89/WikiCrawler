                ...
                public void onResponse(Call call, Response response) throws IOException {
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Log.i(TAG, jsonData);
                            final String[] finalLinkNames = linkNames;
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    mLinkNames = finalLinkNames;
                                    mPageAdapter = new PageAdapter(getSupportFragmentManager(), SecondActivity.this, mSearch);
                                    mViewPager = (ViewPager) findViewById(R.id.pagerSecond);
